...
public class Capacitor_Electrolytic_Leaded: Component, ICapacitor
{
    ...
    public ComponentParameter<double>? LeadSpacing { get; init; }
    ...
    public Capacitor_Electrolytic_Leaded(Component? baseComponent = null)
    {
    ...
    {
        SetName($"Capacitor Electrolytic Leaded {Footprint} {Capacitance} {RatedVoltage} {Tolerance}");
    }
}